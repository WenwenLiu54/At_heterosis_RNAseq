...
exprMat <- "expr_data/TPM_log_shoot_P.txt"
...
write.table(dataExprVar, file = paste(outdir, "TPM_log_shoot_P_filter.txt", sep = "/"), row.names=TRUE, col.names=TRUE, quote=FALSE, sep = "\t")
#############transposition#############
