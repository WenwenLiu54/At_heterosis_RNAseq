...
exprMat <- "expr_data/TPM_log_shoot_F.txt"
...
write.table(dataExprVar, file = paste(outdir, "TPM_log_shoot_F_filter.txt", sep = "/"), row.names=TRUE, col.names=TRUE, quote=FALSE, sep = "\t")
#############transposition#############
