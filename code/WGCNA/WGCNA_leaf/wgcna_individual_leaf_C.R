...
exprMat <- "expr_data/TPM_log_leaf_C.txt"
...
write.table(dataExprVar, file = paste(outdir, "TPM_log_leaf_C_filter.txt", sep = "/"), row.names=TRUE, col.names=TRUE, quote=FALSE, sep = "\t")
#############transposition#############
