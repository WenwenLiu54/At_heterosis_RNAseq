...
write.table(Obs.PreservationStats, file = "leaf_PvsF_Obs.PreservationStats.txt", sep="\t")
write.table(Z.PreservationStats, file = "leaf_PvsF_Z.PreservationStats.txt", sep="\t")


pdf("leaf_PvsF_conservation_z_score.pdf", height = 6, width = 10)
