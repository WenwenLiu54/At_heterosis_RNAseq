...
write.table(Obs.PreservationStats, file = "shoot_CvsF_Obs.PreservationStats.txt", sep="\t")
write.table(Z.PreservationStats, file = "shoot_CvsF_Z.PreservationStats.txt", sep="\t")


pdf("shoot_CvsF_conservation_z_score.pdf", height = 6, width = 10)
