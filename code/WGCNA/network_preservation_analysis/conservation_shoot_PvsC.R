...
datColor = read.table("../TPM_log_shoot_C/gene_module_color.txt", sep="\t", check.names=FALSE)
...
write.table(Obs.PreservationStats, file = "shoot_PvsC_Obs.PreservationStats.txt", sep="\t")
write.table(Z.PreservationStats, file = "shoot_PvsC_Z.PreservationStats.txt", sep="\t")


pdf("shoot_PvsC_conservation_z_score.pdf", height = 6, width = 10)
